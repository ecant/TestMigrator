...
/// Command-line interface for migrating Quick specs to XCTest or Swift Testing.
@main
struct TestMigratorCLI: ParsableCommand {
    static let configuration = CommandConfiguration(abstract: "Migrate Quick specs to XCTest or Swift Testing")
...
/// Extends `URL` to support initialization from command-line arguments.
